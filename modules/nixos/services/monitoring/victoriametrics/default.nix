...
let
  ...
  cfg = config.${namespace}.services.monitoring.victoriametrics;
...
in
{
  options.${namespace}.services.monitoring.victoriametrics = {
    enable = mkEnableOption "Whether or not to manage victoriametrics.";
  };
