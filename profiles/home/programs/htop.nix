    ...
    settings = lib.mkMerge [
      {
        ...
        column_meters_0 = [ "LeftCPUs2" "Memory" "Swap" "Zram" "ZFSARC" "ZFSCARC" ];
        column_meter_modes_0 = [ 1 1 1 1 2 2 ];
        column_meters_1 = [ "RightCPUs2" "Tasks" "LoadAverage" "Uptime" "PressureStallCPUSome" "PressureStallIOSome" "PressureStallMemorySome" ];
